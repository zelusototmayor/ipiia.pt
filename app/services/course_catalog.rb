class CourseCatalog
  ...
  FUNDAMENTOS = Course.new(
    ...
    quiz: [
      { id: "q1", question: "Qual é a forma mais segura de enquadrar uma resposta de IA?", options: [ "Como fonte final de verdade", "Como primeira versão que precisa de validação", "Como substituto de revisão humana", "Como prova factual" ], answer: 1 },
      { id: "q2", question: "O que significa o O em O.C.F.R.I.?", options: [ "Origem", "Objetivo", "Operação", "Output" ], answer: 1 },
      { id: "q3", question: "Qual destes dados deve ser evitado numa ferramenta pública sem aprovação?", options: [ "Exemplo inventado", "Texto sem dados reais", "Dados de clientes identificáveis", "Ideia genérica" ], answer: 2 },
      { id: "q4", question: "Quando falta contexto, qual é o melhor primeiro pedido?", options: [ "Responde já", "Entrevista-me primeiro", "Escreve mais formal", "Usa linguagem técnica" ], answer: 1 },
      { id: "q5", question: "Qual é a principal vantagem de pedir crítica antes de melhoria?", options: [ "Aumenta o tamanho do texto", "Identifica falhas antes de polir", "Evita rever o output", "Garante verdade factual" ], answer: 1 },
      { id: "q6", question: "Um workflow pessoal deve incluir:", options: [ "Input, passos, output, validação e critério de sucesso", "Apenas um prompt longo", "Só uma ferramenta paga", "Apenas uma métrica financeira" ], answer: 0 },
      { id: "q7", question: "Qual é um bom primeiro caso de uso?", options: [ "Automatizar decisão sensível", "Tarefa frequente, clara e fácil de rever", "Substituir uma equipa inteira", "Usar dados confidenciais para testar" ], answer: 1 },
      { id: "q8", question: "O F em O.C.F.R.I. refere-se a:", options: [ "Fonte", "Frequência", "Formato", "Função" ], answer: 2 },
      { id: "q9", question: "O que deve acontecer antes de usar outputs em decisões relevantes?", options: [ "Melhorar o design", "Validação humana e fontes adequadas", "Pedir uma resposta mais longa", "Mudar de modelo" ], answer: 1 },
      { id: "q10", question: "Qual é uma regra mínima para uso empresarial de IA?", options: [ "Usar qualquer ferramenta", "Definir dados proibidos e revisão obrigatória", "Nunca usar IA", "Automatizar primeiro e medir depois" ], answer: 1 },
      { id: "q11", question: "Porque respostas convincentes podem ser perigosas?", options: [ "Porque são sempre falsas", "Porque podem esconder erros com linguagem confiante", "Porque são curtas", "Porque usam listas" ], answer: 1 },
      { id: "q12", question: "Para comparar alternativas, o melhor pedido inclui:", options: [ "Só uma recomendação final", "Três opções, trade-offs e critérios", "Uma lista sem contexto", "A opção mais rápida sempre" ], answer: 1 },
      { id: "q13", question: "Qual é uma boa métrica simples para um workflow pessoal?", options: [ "Cor favorita", "Tempo poupado ou clareza do output", "Número de palavras geradas", "Quantidade de prompts" ], answer: 1 },
      { id: "q14", question: "Quando a IA infere dados numa tabela, deve-se:", options: [ "Usar se parecer profissional", "Separar factos de inferências e validar", "Pedir mais linhas", "Assumir que está certo" ], answer: 1 },
      { id: "q15", question: "O certificado do curso deve indicar:", options: [ "Certificação oficial pública", "Conclusão com aproveitamento emitida pelo IPIIA", "Licença regulatória", "Garantia de competência técnica avançada" ], answer: 1 }
    ]
  )
